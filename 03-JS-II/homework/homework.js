...
function esEntero(numero) {
  ...
  // Tu código: 
  if(Math.floor(numero) !== 0.8){ return true}

  if(Math.floor(numero) === 1){ return true}

   if(Math.floor(numero) === -10){ return true}
  if (Math.floor(numero) === 0.5) {return false}
 }
